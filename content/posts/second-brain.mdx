...
Wat is een second brein?
Refereer Getting Things Done van David Allen
Wat zijn de voordelen.

### 1. You can't be original

It's impossible to create original content. Everything that can be created is already created in some form. This is not to be discouraging but to encourage you. Because on the other hand, how hard you may try to replicate something, it will always have your personal touch, and that is something that you cannot copy. So if you see something that inspires you to make something but you think "why should I create if it's already been done?". Then remember that you will interpet that content through your own unique lens. You will incorporate your own personal experiences and it will evolve in to your own personal creation. One of my favourite books is "Steal like an artist" By Austin Kleon that goes further into this subject.
...
Everything that you captured is a piece of your personal database. This doesn't have to be single use. From one single piece of captured content you can iterate and create multiple pieces of content. Found a piece of new technology that you like? You could use that new tech to create a series of tutorials for beginners to also get into that tech. Found a piece of art that triggers your creative bone? Create a series based on that technique to find out what makes you tick about that art style. Creating that series will also further enhance your personal database that in the future can inspire new ideas again.

So keep reusing your content, your ideas and keep remixing it.
...
A lot of the times you want to put off creating or organising your ideas until you are in the perfect mindspace. You have an entire weekend to tinker around on personal projects, or the thought of "If I can block out a full day I can get this project done". This can sometimes be neccesary, but most of the time small blocks of consistent work can be way more efficient than large chunks of time hammered down on one thing.
